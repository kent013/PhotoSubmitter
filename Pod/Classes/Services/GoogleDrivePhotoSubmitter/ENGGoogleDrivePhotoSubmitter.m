//
//  ENGGoogleDrivePhotoSubmitter.m
...
#import "ENGGoogleDrivePhotoSubmitter.h"
...
//-----------------------------------------------------------------------------
@interface ENGGoogleDrivePhotoSubmitter(PrivateImplementation)
...
@implementation ENGGoogleDrivePhotoSubmitter(PrivateImplementation)
...
- (void)viewController:(GTMOAuth2ViewControllerTouch *)viewController
    ...
    if (error != nil) {
        ...
        UIAlertView *alert =
        [[UIAlertView alloc] initWithTitle:ENGPhotoSubmitterLocalization(@"GDrive_Attention_Title") 
                                   message:ENGPhotoSubmitterLocalization(@"GDrive_Attention_Message")
                                  delegate:self 
                         cancelButtonTitle:
         ENGPhotoSubmitterLocalization(@"GDrive_Attention_Button_Title")
...
@implementation ENGGoogleDrivePhotoSubmitter
...
-(void)onLogin{
    if([PhotoSubmitterManager isSubmitterEnabledForType:@"picasa"]){
        UIAlertView *alert =
        [[UIAlertView alloc] initWithTitle:ENGPhotoSubmitterLocalization(@"GData_Error_Title") 
                                   message:ENGPhotoSubmitterLocalization(@"GData_Error_Message")
                                  delegate:self 
                         cancelButtonTitle:
         ENGPhotoSubmitterLocalization(@"GData_Error_Button_Title")
                         otherButtonTitles:nil];
        [alert show];
        [self disable];
        return;
