...
@interface MetaMovicsRequest : NSObject<NSURLConnectionDelegate, NSURLConnectionDataDelegate>{
    __strong NSString *tag_;
    __strong NSURLConnection *connection_;
    __strong NSMutableData *data_;
    __weak id<MetaMovicsRequestDelegate> delegate_;
}
@property (nonatomic, readonly) NSURL *url;
@property (nonatomic, readonly) NSString *httpMethod;
@property (nonatomic, readonly) NSURLConnection *connection;
@property (nonatomic, strong) NSString *tag;
@property (nonatomic, weak) id<MetaMovicsRequestDelegate> delegate;
