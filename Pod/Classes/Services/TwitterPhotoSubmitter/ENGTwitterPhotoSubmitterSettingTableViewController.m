...
//-----------------------------------------------------------------------------
@interface ENGTwitterPhotoSubmitterSettingTableViewController(PrivateImplementation)
- (void) setupInitialState;
- (ENGTwitterPhotoSubmitter *)twitterSubmitter;
@end

@implementation ENGTwitterPhotoSubmitterSettingTableViewController(PrivateImplementation)
/*!
 * initialize
 */
-(void)setupInitialState{
 ...
 */
- (ENGTwitterPhotoSubmitter *)twitterSubmitter{
    return (ENGTwitterPhotoSubmitter *)self.submitter;
}
@end
...
//-----------------------------------------------------------------------------
@implementation ENGTwitterPhotoSubmitterSettingTableViewController
...
- (NSString *)tableView:(UITableView *)tableView titleForHeaderInSection:(NSInteger)section{
    ...
    switch (section) {
        case TSV_SECTION_ACCOUNTS: return [self.submitter.name stringByAppendingString:ENGPhotoSubmitterLocalization(@"Detail_Section_Twitter_Accounts")] ; break;
    }
