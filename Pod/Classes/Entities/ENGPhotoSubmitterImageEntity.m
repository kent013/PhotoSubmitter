//
//  ENGPhotoSubmitterImageEntity.m
//
...
//-----------------------------------------------------------------------------
@interface ENGPhotoSubmitterImageEntity(PrivateImplementatio)
- (void) preserveMetadata;
- (void) applyMetadata:(NSData *)data preservedMetadata:(NSMutableDictionary *)preservedMetadata;
- (void) autoEnhance;
@end

@implementation ENGPhotoSubmitterImageEntity(PrivateImplementation)
/*!
 * preserve metadata
 */
- (void)preserveMetadata{
...
//----------------------------------------------------------------------------
@implementation ENGPhotoSubmitterImageEntity
...
- (void)preprocess{
    ...
    if([ENGPhotoSubmitterSettings getInstance].autoEnhance){
        [self autoEnhance];
    }
 ...
 */
- (ENGPhotoSubmitterImageEntity *)autoRotatedImageEntity{
    return nil;
}
...
- (ENGPhotoSubmitterContentType)type{
    return ENGPhotoSubmitterContentTypePhoto;
}
@end
